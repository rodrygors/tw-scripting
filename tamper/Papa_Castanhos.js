...
// @name     PAPA CASTANHOS!!!
// correção		xd
// @include  **.tribalwars.com.*place*
// @grant    none
// ==/UserScript==

var tempo = 2000;
var x = 2000;
var autoFillVillages = 0; //Se = 1, script vai aceder à lista de aldeias para partir muralha criada pelo script bbFarmer
...
var coords = "";
if(autoFillVillages) {
    if(window.localStorage.getItem('villagesToBeWalled') != null){
        coords = window.localStorage.getItem('villagesToBeWalled');
        console.log(coords);
    }
}
